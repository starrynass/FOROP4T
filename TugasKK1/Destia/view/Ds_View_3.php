...
<div class="data-section">
    <h2> II - Menampilkan Siswa Yang Diajar Berdasarkan NIP Guru
    <h3>SQL JOIN</h3>
...
<table>
            ...
            <?php if ($View_Informasi_3 && $View_Informasi_3->num_rows > 0) { ?>
                <?php while($row = $View_Informasi_3->fetch_assoc()) { ?>
                    <tr>
